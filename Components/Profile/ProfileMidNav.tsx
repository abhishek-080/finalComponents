            ...
            <div className="row border  rounded ms-n4 me-n4">
                ...
                <ul className="d-flex justify-content-center nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder bg-white p-3 rounded">
                    ...
                    <li className="nav-item mt-2">
                        <a className="nav-link text-active-primary ms-0 me-10 py-5 active" href="/metronic8/demo1/../demo1/pages/user-profile/overview.html">Posts</a>
                    </li>
                    {/* <!--end::Nav item-->
										<!--begin::Nav item--> */}
                    <li className="nav-item mt-2">
                        <a className="nav-link text-active-primary ms-0 me-10 py-5" href="/metronic8/demo1/../demo1/pages/user-profile/projects.html">About</a>
                    </li>
                    {/* <!--end::Nav item-->
										<!--begin::Nav item--> */}
                    <li className="nav-item mt-2">
