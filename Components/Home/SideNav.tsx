    ...
    <div>
        <div id="kt_aside" className="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle" >
							...
							<div className="menu-item">
								<div className="menu-link" >
									<span className="menu-icon">
										...
										<div className="menu-title text-gray-400  fs-2 fw-bolder me-1 d-flex flex-wrap">
											<div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative shadow">
												<img src="/assets/media/avatars/300-1.jpg" alt="image" />
											</div>
											<div className="user-name text-dark text-hover-success p-6">
												Nikhil Upreti
											</div>
										</div>
									</div>
							...
							{/* end profile section */}
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									<span className="menu-link">
										...
										<span className="menu-title fs-4">Threads</span>
					...
					<div className="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
						<a href="../../demo1/dist/documentation/getting-started.html" className="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip" >
