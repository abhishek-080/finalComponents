...
import PopupSignup from "./registerModal";
            ...
            >
              ...
              <div className="sigin-header  mb-10 ">
                ...
                {/* <!--end::Title-->
                 ...
                 <div className="text-black-400  fs-5 fw-bolder">
                  Not a memeber yet?
                  {/* <Link href="./PopupSignin">
                    <a style={{ textDecoration: "none" }} > Signup </a>
                  </Link> */}
                  <span className="acc-signup " style={{cursor:'pointer', color:'blue'}}>

                    <PopupSignup istext={true} />
                  </span>
                </div>
              ...
              <div className="text-center">
                ...
                <div className="signin-btn">
                  ...
                  >
                    <Link href='./profile-home'><a className='text-decoration-none text-white'>Sign in</a></Link>
