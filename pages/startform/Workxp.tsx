										...
										<div className="fv-row">
											...
											<div className="row">
												...
												<div className="col-lg-3 col-md-5 col-sm-6">
													{/* <!--begin::Option--> */}
													<input type="radio" className="btn-check" name="account_type" value="personal"  id="kt_create_account_form_account_type_personal" />
													<label className="btn-outline btn-outline-light btn-outline-default p-7 d-flex justify-content-center mb-10" htmlFor="kt_create_account_form_account_type_personal">
